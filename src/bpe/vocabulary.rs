...
///
/// ## R50K tokens
pub (crate) static R50K_TOKENS: LazyLock<BTreeMap<Vec<u8>, usize>> = LazyLock::new(|| {
...
///
/// ## P50K tokens
pub (crate) static P50K_TOKENS: LazyLock<BTreeMap<Vec<u8>, usize>> = LazyLock::new(|| {
    let mut encoder = std::collections::BTreeMap::new();
...
///
/// ## CL100K tokens
pub (crate) static CL100K_TOKENS: LazyLock<BTreeMap<Vec<u8>, usize>> = LazyLock::new(|| {
    let mut encoder = std::collections::BTreeMap::new();
...
///
/// ## O200K tokens
pub (crate) static O200K_TOKENS: LazyLock<BTreeMap<Vec<u8>, usize>> = LazyLock::new(|| {
    let mut encoder = std::collections::BTreeMap::new();
